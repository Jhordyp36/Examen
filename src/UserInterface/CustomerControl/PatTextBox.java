...
public class PatTextBox extends JTextField {
    ...
    private void customizeComponent() {
        ...
        setForeground(PTStyleUI.COLOR_FONT_LIGHT);  
        setCaretColor(PTStyleUI.COLOR_CURSOR);    // Color del cursor
    ...
    public void setBorderRect() {
        Border lineBorder = BorderFactory.createLineBorder(PTStyleUI.COLOR_BORDER);
    ...
    public void setBorderLine(){
        ...
        setBorder(  BorderFactory.createCompoundBorder(
                    ...
                    BorderFactory.createMatteBorder(0, 0, thickness, 0, PTStyleUI.COLOR_BORDER) 
        ));
    }
}
